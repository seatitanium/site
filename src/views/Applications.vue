...
const data: Term[] = [
    {
        ...
        applications: [
            ...
            },
            {
                ...
                sharables: {
                    '填写一段对现实中，或者网络中，或者理想中的自己的介绍': '各类整合包的锁阶段最好不要是生硬的锁，反例即为玄理2。较好的锁阶段是格雷的各个电压等级的材料，这些在到了阶段后是要大量投入实际生产当中去的<br/>模组添加模型不要用三角面建模多面体，材质需要是具有美术水平的16x，最多是仿16x的32x，反例为恐怖生物<br/>个人经验会于毕业后更新于st wiki的自动化笔记上'
                },
                passed: true
            },
            {

        ...
        <div class="container">
          ...
          <div class="welcome">
            ...
            <div class="welcome-btns">
              <btn class="primary-a shadow arrow" size="large" icon="arrow-top-right">立即加入 Seati 讨论群</btn>
              <btn class="primary-o shadow arrow" size="large" icon="arrow-top-right">立即加入 Oasis 讨论群</btn>
            </div>
          </div>
        </div>
      </section>
